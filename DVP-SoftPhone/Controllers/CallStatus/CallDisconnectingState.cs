...
{
    #region Class
    internal class CallDisconnectingState : CallState
    {
        ...
        public override void OnDisconnected(Call call, string reason)
        {
            ...
            {
                Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "OnDisconnected", exception, Logger.LogLevel.Error);
            }
        }
        ...
        public override void OnDisconnectFail(Call call)
        {
            try
            {
                call.UiState.ShowMessage("Fail To Disconnect", System.Windows.Forms.ToolTipIcon.Error);
                call.CallCurrentState = new CallConnectingState();
            }
            catch (Exception exception)
            {
                Logger.Instance.LogMessage(Logger.LogAppender.DuoLogger3, "OnDisconnectFail", exception, Logger.LogLevel.Error);
            }
        }
